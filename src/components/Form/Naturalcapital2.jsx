...
function Naturalcapital2({ setCurrentPage, setMainFormData, mainFormData }) {
  ...
  useEffect(() => {
    if (mainFormData.Naturalcapital.Farmlandindisasterareas) {
      setFormData((prevData) => ({
        ...prevData,
        Farmlandindisasterareas:
          mainFormData.Naturalcapital.Farmlandindisasterareas,
  ...
  const validateHouseInDisaster = (formData) => {
    ...
    const hasSelection =
      formData.HouseInDisasterAreas?.[0]?.is_in_disaster !== null &&
    ...
    if (formData.HouseInDisasterAreas?.[0]?.is_in_disaster === true) {
      const validHouseInDisasterAreas = formData.HouseInDisasterAreas.every(
        (item) => {
          // ตรวจสอบว่า disaster_type ถูกกรอกถ้าเลือก "อื่นๆ (ระบุ)"
          const isOtherDisaster =
            item.disaster_type?.startsWith(prefixHouse) &&
            item.disaster_type?.slice(prefixHouse.length).trim() === "";
          const isValidDisaster =
            item.disaster_type?.trim() !== "" &&
  ...
  const validateFarmlandInDisasterAreas = (formData) => {
    const hasSelection =
      formData.Farmlandindisasterareas?.[0]?.is_in_disaster !== null &&
    ...
    if (formData.Farmlandindisasterareas?.[0]?.is_in_disaster === true) {
      const validFarmlandindisasterareas =
        formData.Farmlandindisasterareas.every((item) => {
          // ตรวจสอบว่า disaster_type ถูกกรอกถ้าเลือก "อื่นๆ (ระบุ)"
          const isOtherDisaster =
            item.disaster_type?.startsWith(prefixHouse) &&
            item.disaster_type?.slice(prefixHouse.length).trim() === "";
  ...
  const OtherHouse = (prefix) => (e) => {
    ...
    setFormData((prevState) => {
      const updatedHouse = [...prevState.HouseInDisasterAreas];
      const groupIndex = updatedHouse.findIndex((group) =>
        group.disaster_type.startsWith(prefix)
      );
  ...
  const OtherFarm = (prefix) => (e) => {
    ...
    setFormData((prevState) => {
      ...
      const groupIndex = updateFarm.findIndex((group) =>
        group.disaster_type.startsWith(prefix)
      );
          ...
          <div className="flex flex-col gap-2 pl-12">
            ...
            <label className="flex items-center text-gray-700">
              <input
                ...
                checked={
                  formData.HouseInDisasterAreas[0]?.is_in_disaster === false
                }
                value={false}
                    ...
                    <td className="border px-4 py-3">
                      <label className="flex items-center space-x-2">
                        <input
                          ...
                          checked={formData.HouseInDisasterAreas.some(
                            (group) =>
                              group.disaster_type === "ไฟจากไฟป่าและหมอกควัน"
                          )}
                          onChange={(e) =>
                            handleHouseCheckboxChange(
                              e.target.value,
                    ...
                    <td className="border px-4 py-3">
                      <label className="flex items-center space-x-2">
                        <input
                          ...
                          checked={formData.HouseInDisasterAreas.some(
                            (group) =>
                              group.disaster_type === "ภัยโรคระบาดในมนุษย์"
                          )}
                          onChange={(e) =>
                            handleHouseCheckboxChange(
                              e.target.value,
                    ...
                    <td className="border px-4 py-3">
                      <label className="flex items-center space-x-2">
                        <input
                          type="checkbox"
                          className="form-checkbox text-blue-600 mr-2 rounded"
                          checked={formData.HouseInDisasterAreas.some((group) =>
                            group.disaster_type.startsWith(prefixHouse)
                          )}
                          onChange={OtherHouse(prefixHouse)}
                        />
                        <span>อื่นๆ (ระบุ)</span>
                        {formData.HouseInDisasterAreas.some((group) =>
                          group.disaster_type.startsWith(prefixHouse)
                        ) && (
                          <input
                            type="text"
      ...
      > 
        <div className="Container">
          <h1 className="text-lg font-bold text-gray-700 mb-5">
            ...
            ครัวเรือนของท่านมีที่ทำกิน (รวมชายฝั่งทะเล กรณีชาวประมงพื้นบ้าน
            และแหล่งน้ำจืดธรรมชาติ
            กรณีชาวประมงพื้นบ้านและการเพาะเลี้ยงสัตว์น้ำน้ำจืด)
            อยู่ในพื้นที่ภัยพิบัติหรือไม่
          </h1>
          <div className="flex flex-col gap-2 pl-12">
            <label className="flex items-center text-gray-700">
              <input
                ...
                checked={
                  formData.Farmlandindisasterareas[0]?.is_in_disaster === false
                }
                value={false}
                  ...
                  <tr>
                    ...
                    <td className="border px-4 py-3 text-center">
                      <select
                        ...
                        onChange={(e) =>
                          handleFrequncyChange("อุทกภัย", e.target.value)
                        }
                      >
                        <option value="" disabled>
                          เลือกสถานะ
                    ...
                    <td className="border px-4 py-3 text-center flex">
                      <select
                        ...
                        onChange={(e) =>
                          handleResponseChange("อุทกภัย", e.target.value)
                        }
                      >
                        <option value="" disabled>
                          เลือกสถานะ
                  ...
                  <tr>
                    ...
                    <td className="border px-4 py-3 text-center">
                      <select
                        ...
                        onChange={(e) =>
                          handleFrequncyChange("ดินโคลนถล่ม", e.target.value)
                        }
                      >
                        <option value="" disabled>
                          เลือกสถานะ
                    ...
                    <td className="border px-4 py-3 text-center flex">
                      <select
                        ...
                        onChange={(e) =>
                          handleResponseChange("ดินโคลนถล่ม", e.target.value)
                        }
                      >
                        <option value="" disabled>
                          เลือกสถานะ
                  ...
                  <tr>
                    ...
                    <td className="border px-4 py-3 text-center">
                      <select
                        ...
                        onChange={(e) =>
                          handleFrequncyChange("วาตภัย", e.target.value)
                        }
                      >
                        <option value="" disabled>
                          เลือกสถานะ
                    ...
                    <td className="border px-4 py-3 text-center flex">
                      <select
                        ...
                        onChange={(e) =>
                          handleResponseChange("วาตภัย", e.target.value)
                        }
                      >
                        <option value="" disabled>
                          เลือกสถานะ
                  ...
                  <tr>
                    ...
                    <td className="border px-4 py-3 text-center">
                      <select
                        ...
                        onChange={(e) =>
                          handleFrequncyChange("อัคคีภัย", e.target.value)
                        }
                      >
                        <option value="" disabled>
                          เลือกสถานะ
                    ...
                    <td className="border px-4 py-3 text-center flex">
                      <select
                        ...
                        onChange={(e) =>
                          handleResponseChange("อัคคีภัย", e.target.value)
                        }
                      >
                        <option value="" disabled>
                          เลือกสถานะ
                  ...
                  <tr>
                    ...
                    <td className="border px-4 py-3 text-center">
                      <select
                        ...
                        onChange={(e) =>
                          handleFrequncyChange("ภัยแล้ง", e.target.value)
                        }
                      >
                        <option value="" disabled>
                          เลือกสถานะ
                    ...
                    <td className="border px-4 py-3 text-center flex">
                      <select
                        ...
                        onChange={(e) =>
                          handleResponseChange("ภัยแล้ง", e.target.value)
                        }
                      >
                        <option value="" disabled>
                          เลือกสถานะ
                  ...
                  <tr>
                    <td className="border px-4 py-3">
                      <label className="flex items-center space-x-2">
                        ...
                        />
                        <span>อื่นๆ (ระบุ)</span>
                        {formData.Farmlandindisasterareas.some((group) =>
                          group.disaster_type.startsWith(prefixHouse)
                        ) && (
                          <input
                            type="text"
                    ...
                    <td className="border px-4 py-3 text-center">
                      <select
                        ...
                        onChange={(e) =>
                          handleFrequncyChange(prefixHouse, e.target.value)
                        }
                      >
                        <option value="" disabled>
                          เลือกสถานะ
                    ...
                    <td className="border px-4 py-3 text-center flex">
                      <select
                        ...
                        onChange={(e) =>
                          handleResponseChange(prefixHouse, e.target.value)
                        }
                      >
                        <option value="" disabled>
                          เลือกสถานะ
                        ...
                        <option value="ชุมชนมีระบบบริหารจัดการรองรับภัยพิบัติและสามารถฟื้นตัว">
                          {" "}
                          ชุมชนมีระบบบริหารจัดการรองรับภัยพิบัติและสามารถฟื้นตัว
                          เข้าสู่ภาวะปกติได้
                        </option>
