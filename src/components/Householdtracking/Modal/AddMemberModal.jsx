...
const AddMemberModal = ({ show, onClose, household, reloadData }) => {
    ...
    const validateInput = () => {
        ...
        for (let index = 0; index < members.length; index++) {
            ...
            if (
                ...
                errors.push(
                    `กรุณากรอกเลขบัตรประชาชนของสมาชิคคนที่ ${index + 1
        ...
        try {
            ...
            if (res.isConfirmed) {
                ...
                const response = await axios.post(
                    ...
                    `${config.api_path}/house-hold/create-member/${household.id}`,
                    members, // Include the NonAGIincome array in the request body
                    config.headers()
                );
                ...
                <div>
                    ...
                    <form onSubmit={(e) => handleSubmit(e)}>
                        {members.map((member, index) => (
                            <div key={`member-${index}`} className="mb-6 mx-10 mt-5 py-5 bg-blue-200 rounded-md">
                                ...
                                <div className="mx-6 py-2 grid 2xl:grid-cols-3 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 gap-4">
                                    {/* รายได้เฉลี่ย */}
                                    <div className="flex flex-col">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleMemberfinancialChange(index, "agv_income", e.target.value)}
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleMemberfinancialChange(index, "avg_expenses", e.target.value)}
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full min-w-[200px] p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder=""
                                            required
                                        />
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleMemberfinancialChange(index, "inflation", e.target.value)}
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full min-w-[200px] p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder=""
                                            required
                                        />
                                ...
                                <button
                                    ...
                                    className="flex justify-center focus:outline-none mb-3 px-8 mx-6 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm  py-2.5 me-2  dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 mt-4"
                                >
                                    <Icon
